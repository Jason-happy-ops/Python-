...
Day 7 2025.11.20
今天写了三个小时代码，硬生生把cursor的免费AI使用次数用完了，才指写完数模的一道题。用matplotlib库绘制了两幅图，第一幅为美国巴西阿根廷对
中国出口的大豆量。第二幅是使用cms模型拟合的曲线，以2024年之前的数据为基准，由于关税问题，2025年后的数据偏差较大。今天学的最多的就是怎么做出
漂亮的图片，算法那部分其实我不太会写，丢给AI了，以后希望能多学一学这些算法。关于AI对编程的作用我其实挺困惑的，用了感觉代码不是自己的，不用的话又
写不出来。以后希望能自己独立去写框架
